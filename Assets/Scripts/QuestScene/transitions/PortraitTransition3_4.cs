...
{
    public class PortraitTransition3_4 : Transition
    {
        public PortraitTransition3_4(string questNodeId, int choiceNum) : base(questNodeId, choiceNum)
        {
        }
        ...
        public override void run(QuestNode currentQuestNode, int clickedChoiceNum, QuestSceneFlow questSceneFlow)
        {
            ...
            {
                questPanelController.displayQuestNode("3.4");
            });
        }
    }
}